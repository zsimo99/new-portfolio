...
const Service = ({ title, icon, desc, id }) => {
    return (
        <div className={`max-w-xs bg-[#103c3d] px-5 py-14 text-white flex items-center justify-between space-y-3 flex-col  hide duration-700 transition-[opacity,transform] ${id === 1 && "xl:-translate-y-10"}`}>
