    ...
    return (
        <div className="container mx-auto px-4 projects flex flex-col gap-10 mt-14" >
            ...
            {projects.filter(project => project.category === service).slice(0, 5).length > 5 && <>
                <button className="hide duration-700 transition-[opacity,transform] px-10 py-2 md:px-14 md:py-4 xl:px-16 xl:py-5 bg-slate-500 mt-4 block mx-auto rounded-md text-2xl font-bold text-white bg-gradient-to-r to-[#309092] from-[#6CC6C8] relative z-0">
