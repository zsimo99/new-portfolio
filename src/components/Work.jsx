...
const Work = () => {
    ...
    return (
        <section id="portfolio" className="py-32 bg-[#032324] text-white">
            <h2 className="text-center text-4xl lg:text-5xl xl:text-6xl font-extrabold text-[#309092] mb-4 hide duration-700 transition-[opacity,transform]">Portfolio</h2>
            <ul className="flex gap-4 sm:gap-5 lg:gap-10 w-fit mx-auto hide duration-700 transition-[opacity,transform]">
