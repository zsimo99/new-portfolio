...
const AboutUs = () => {
    ...
    return (
        ...
        >
            <div className="container mx-auto px-4 flex max-lg:flex-col gap-10 items-center">
                <div className=" lg:basis-1/2">
                    <h2 className="lg:hidden mb-8 text-5xl md:text-6xl xl:text-7xl  font-extrabold text-[#40dcdf] mb-4 hide duration-700 transition-[opacity,transform] ">
                        About Us:
                    </h2>
                ...
                <div className="lg:basis-1/2">
                    <h2 className="max-lg:hidden text-5xl md:text-6xl xl:text-7xl  font-extrabold text-[#40dcdf] mb-4 hide duration-700 transition-[opacity,transform] ">
                        About Us:
                    </h2>
                    <p className="text-base text-start md:text-lg xl:text-xl md:text-justify font-medium text-white pl-10 hide duration-700 transition-[opacity,transform]">
